...
module.exports.http = {
  ...
  customMiddleware: function(app) {
    ...
    passport.use(new GoogleStrategy({
      clientID: '618498770530-enbtpueadh8rrvu793acme3liad9qtmp.apps.googleusercontent.com',
      clientSecret: 'AUv7mdur7jzviP2rVr4gOBA8',
      callbackURL: 'http://localhost:1337/auth/google/callback'
    }, function(accessToken, refreshToken, profile, cb) {
      console.log("Caught it inside oauth");
      console.log(profile);
